    ...
    <div className={style.membershipform}>
        ...
        <form onSubmit={insertFn}>
            ...
            <div className={style.PWrecontents}>
                ...
                <input type='password' name='pw_rec' placeholder='비밀번호를 한번 더 입력해주세요' id='pw2'onChange={onChangePasswordConfirm} 
            ...
            <div className={style.Numbercontents}>
                <b>휴대폰번호</b>
                <input type='number' name='number' placeholder='하이픈을 제외한 숫자만 입력해주세요' className={style.numberEnter} required/>
            </div>
            <div className={style.Membershipbtn}>
                <p>제주도로 떠나볼까요?</p>
                <input type='submit' name='Login' className={style.membershipbtn} value='가입하기'/>
            </div>
        </form>
    </div>
  )
